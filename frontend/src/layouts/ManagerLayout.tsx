...
import { LayoutDashboard, Users, Calendar, Clock, LogOut, ChevronRight, Building2, Menu, X, UserCog, ClipboardList } from 'lucide-react';
...
export default function ManagerLayout() {
  ...
  const isActive = (to: string) => {
    if (to === '/manager') return currentPath === '/manager' || currentPath === '/manager/';
        ...
        <header className="bg-white border-b border-[oklch(0.88_0.01_240)] px-4 py-3 flex items-center justify-between flex-shrink-0 shadow-xs">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-sm text-[oklch(0.52_0.02_250)]">
              ...
              <span className="text-[oklch(0.18_0.04_255)] font-medium">Manager Portal</span>
            </div>
          </div>
