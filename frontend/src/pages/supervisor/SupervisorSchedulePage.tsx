...
export default function SupervisorSchedulePage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Department Schedules</h1>
        <p className="text-muted-foreground text-sm">View published schedules by department</p>
      </div>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-1">
                            {overnight && <Moon className="h-3 w-3 text-indigo-500 shrink-0" />}
