...
const TimeOffRequestsPage = lazy(
  () => import("./pages/hr/TimeOffRequestsPage"),
);
const HiringPage = lazy(() => import("./pages/hr/HiringPage"));
const CreateJobPostingPage = lazy(
  () => import("./pages/hr/CreateJobPostingPage"),
);
const ApplicantPipelinePage = lazy(
  () => import("./pages/hr/ApplicantPipelinePage"),
);
...
const AccountManagementPage = lazy(
  () => import("./pages/hr/AccountManagementPage"),
);
...
const ManagerSchedulingPage = lazy(
  () => import("./pages/manager/ManagerSchedulingPage"),
);
const ManagerTimeOffPage = lazy(
  () => import("./pages/manager/ManagerTimeOffPage"),
);
const ManagerAccountManagementPage = lazy(
  () => import("./pages/manager/ManagerAccountManagementPage"),
);
const ManagerTimesheetPage = lazy(
  () => import("./pages/manager/ManagerTimesheetPage"),
);
...
const EmployeeTimeOffPage = lazy(
  () => import("./pages/employee/EmployeeTimeOffPage"),
);
const EmployeeTimesheetPage = lazy(
  () => import("./pages/employee/EmployeeTimesheetPage"),
);
...
const SupervisorSchedulePage = lazy(
  () => import("./pages/supervisor/SupervisorSchedulePage"),
);
const SupervisorTimeOffPage = lazy(
  () => import("./pages/supervisor/SupervisorTimeOffPage"),
);
...
const hrAddEmployeeRoute = createRoute({
  getParentRoute: () => hrLayoutRoute,
  path: "/employees/new",
...
const hrCreateJobPostingRoute = createRoute({
  getParentRoute: () => hrLayoutRoute,
  path: "/hiring/new",
  component: () => <CreateJobPostingPage />,
});
const hrApplicantPipelineRoute = createRoute({
  getParentRoute: () => hrLayoutRoute,
...
const hrPTOPolicyNewRoute = createRoute({
  getParentRoute: () => hrLayoutRoute,
  path: "/pto-policies/new",
  component: () => <PTOPolicyFormPage />,
});
const hrPTOPolicyEditRoute = createRoute({
  getParentRoute: () => hrLayoutRoute,
...
const hrAccountManagementRoute = createRoute({
  getParentRoute: () => hrLayoutRoute,
  path: "/accounts",
...
const managerAccountManagementRoute = createRoute({
  getParentRoute: () => managerLayoutRoute,
  path: "/accounts",
...
const supervisorScheduleRoute = createRoute({
  getParentRoute: () => supervisorLayoutRoute,
  path: "/schedules",
