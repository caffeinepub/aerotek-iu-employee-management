...
const navItems = [
  ...
  { to: "/employee/timesheet", label: "Timesheet", icon: ClipboardList },
  { to: "/employee/time-off", label: "Time Off", icon: Clock },
      ...
      >
        ...
        <div className="px-5 py-3 border-b border-[oklch(0.28_0.04_255)] flex-shrink-0">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-full bg-[oklch(0.62_0.18_160)] flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-[oklch(0.78_0.16_75)] text-xs">Employee</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b border-[oklch(0.88_0.01_240)] px-4 py-3 flex items-center justify-between flex-shrink-0 shadow-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs bg-[oklch(0.62_0.18_160)] text-white px-2.5 py-1 rounded-full font-semibold">
              Employee
            </span>
          </div>
        </header>
