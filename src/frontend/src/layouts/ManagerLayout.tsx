...
const navItems = [
  ...
  { to: "/manager/team", label: "Team Directory", icon: Users },
  { to: "/manager/scheduling", label: "Scheduling", icon: Calendar },
  { to: "/manager/time-off", label: "Time Off Requests", icon: Clock },
  { to: "/manager/timesheets", label: "Timesheets", icon: ClipboardList },
  { to: "/manager/accounts", label: "Account Management", icon: UserCog },
];
      ...
      >
        ...
        <div className="px-5 py-3 border-b border-[oklch(0.28_0.04_255)] flex-shrink-0">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-full bg-[oklch(0.55_0.18_255)] flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-[oklch(0.78_0.16_75)] text-xs">Manager</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b border-[oklch(0.88_0.01_240)] px-4 py-3 flex items-center justify-between flex-shrink-0 shadow-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs bg-[oklch(0.55_0.18_255)] text-white px-2.5 py-1 rounded-full font-semibold">
              Manager
            </span>
          </div>
        </header>
