...
import SendUrgentAlertModal from "../components/SendUrgentAlertModal";
  ...
  return (
    <div className="flex h-screen bg-[oklch(0.97_0.005_240)] overflow-hidden">
      ...
      >
        ...
        {/* Scrollable nav + logout + urgent alert */}
        <ScrollArea className="flex-1">
          ...
          {/* Send Urgent Alert button — HR Admin only */}
          <div className="px-3 pt-2 pb-2 mx-3">
            <button
              type="button"
              onClick={() => {
              ...
              className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-bold bg-red-700 hover:bg-red-800 text-white transition-all"
            >
              <Siren className="w-4 h-4 flex-shrink-0" />
              <span>Send Urgent Alert</span>
            </button>
          </div>
      ...
      {/* Send Urgent Alert Modal */}
      <SendUrgentAlertModal
