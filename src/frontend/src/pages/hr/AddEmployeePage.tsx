...
import { type Employee, EmployeeStatus, Role } from "../../backend";
import {
...
export default function AddEmployeePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(
        `Failed to create employee: ${e instanceof Error ? e.message : "Unknown error"}`,
      );
    }
  };
              ...
              <div className="space-y-1">
                ...
                {managers.length === 0 ? (
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      handleChange("directManagerId", v === "__none__" ? "" : v)
                    }
                  >
                    <SelectTrigger>
